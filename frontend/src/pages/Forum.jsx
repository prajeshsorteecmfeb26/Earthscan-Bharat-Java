...
export default function Forum() {
    ...
    const handleCreatePost = async () => {
        ...
        try {
            ...
            const created = response.data?.post || response.data;
            setPosts(prev => [created, ...(Array.isArray(prev) ? prev : [])]);
            ...
            <Row>
                <Col lg={8}>
                    {loading ? (
                        ...
                        posts.map(post => (
                            <Card key={post.id || Math.random()} className="glass-panel border-0 text-white mb-4">
                                <Card.Body className="p-4">
                                    <div className="d-flex justify-content-between align-items-start mb-3">
                                        <div className="d-flex align-items-center gap-3">
                                            ...
                                            <div>
                                                <h6 className="mb-0 fw-bold">{post.authorName || 'Anonymous'}</h6>
