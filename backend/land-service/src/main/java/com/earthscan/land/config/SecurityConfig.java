...
/**
 * Security for land-service.
 *
 * <p>GET on {@code /api/lands/**} is open so unauthenticated visitors can browse the marketplace;
 * every mutating verb requires a token, and the role rules live in {@code @PreAuthorize} on the
 * controller next to the operation they govern.</p>
 */
@Configuration
@EnableWebSecurity
    ...
    public SecurityFilterChain filterChain(HttpSecurity http,
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // Public browsing, authenticated writes.
                        .requestMatchers(HttpMethod.GET, "/api/lands", "/api/lands/**").permitAll()
                        .requestMatchers("/api/lands/mine").authenticated()
